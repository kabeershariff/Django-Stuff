...
def create_question(question_text, days):
    """
    create questions, and days if -ve means past and +ve in future blah blah
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a pub_date in past are shown in index page.
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of question with pub_date in the future. returns 404 not found
        """
